...
Esta primeira versão da lista não será a última. Esperamos atualizá-la periodicamente para acompanhar o estado e desenvolvimento da indústria. Trabalharemos com a comunidade em geral para impulsionar a tecnologia de ponta, adicionalmente, criaremos materiais para finalidades diversas e educativas. Também buscaremos colaborar com órgãos reguladores e governos nos temas de segurança de IA. Convidamos você a fazer parte e contribuir com nosso grupo.
